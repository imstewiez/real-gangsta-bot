...
const ONBOARDING = {
  ...
  PROMOTED_TO_OFICIAL: (mention) =>
    `${E.LIDER} ${mention} sobe a **Oficial**.`,

  FAREWELL: (name) => `${E.BEMVINDO} ${name} sai da casa. Que corra bem na rua.`,

  // Tópico do canal individual
  CHANNEL_TOPIC: (fullName, nickname) =>
    `Canal de ${fullName} (${nickname}) · Firma RedWood`,
};
