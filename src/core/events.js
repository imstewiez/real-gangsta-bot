...
const EVENTS = {
  // ── Membros ─────────────────────────────────────────────────────────────────
  'member.joined': {
    description: 'Novo membro registado na DB (backfill ou onboarding)',
    tabs: ['membros', 'dashboard'],
  },
  ...
  'member.tier_changed': {
    description: 'Tier alterado (auto-promoção ou lifecycle)',
    tabs: ['membros', 'resumo', 'dashboard'],
  },
  'member.nickname_changed': { description: 'Nickname alterado no Discord', tabs: ['membros'] },

  // ── Material / Inventário ───────────────────────────────────────────────────
  'material.registered': {
    description: 'Entrega ou venda de material registada',
    tabs: ['stock', 'resumo', 'dashboard', 'membros'],
  },
  'material.adjusted': { description: 'Stock ajustado manualmente', tabs: ['stock', 'resumo', 'dashboard'] },
  'material.transferred': {
    description: 'Material movido entre casas (armazém ↔ grupo)',
    tabs: ['stock', 'dashboard'],
  },
  ...
  'saida.closed': {
    description: 'Saída fechada com resultado e totais',
    tabs: ['saidas', 'resumo', 'dashboard', 'membros'],
  },
  ...
  'weapon.return_confirmed': {
    description: 'Devolução de arma confirmada pela chefia',
    tabs: ['saidas', 'membros', 'dashboard'],
  },
  'weapon.return_rejected': {
    description: 'Devolução de arma rejeitada pela chefia',
    tabs: ['saidas', 'membros', 'dashboard'],
  },
