...
const MIGRATIONS = [
  ...
  {
    id: 26,
    name: 'fix_movement_type_constraint_and_qty',
    // BUG FIX: migration #20 sobrescreveu o CHECK com nomes antigos
    // (consumo_operacao, devolucao_operacao, perda_operacao) que #11
    // já tinha renomeado para *_saida. O constraint actual rejeita
    // os nomes correctos. Também corrige o CHECK de quantity > 0 →
    // quantity <> 0 para permitir ajustes manuais negativos.
    up: `
