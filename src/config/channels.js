...
module.exports = {
  // Categorias
  BAIRRISTA_TOPICOS_CATEGORY_ID: guildId('BAIRRISTA_TOPICOS_CATEGORY_ID', 'categories') || '1495206698791600159',
  ...
  BAIRRISTA_WEEKLY_PRIZE_CHANNEL_ID: optId('BAIRRISTA_WEEKLY_PRIZE_CHANNEL_ID', '1490397812872183889'),
